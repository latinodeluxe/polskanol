    ...
    return (
      <main className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <a href="/dashboard" className="text-red-500 font-medium">Volver al inicio</a>
        </div>
      </main>
    )
  }
            ...
            {!mostrarResultado ? (
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm text-center">
                ...
                <div className="flex gap-4 justify-center">
                  ...
                  <a href={"/curso/" + siguienteLeccion} className="px-6 py-3 bg-red-500 text-white rounded-xl font-semibold">Siguiente leccion</a>
                </div>
              </div>
            )}
          </div>
